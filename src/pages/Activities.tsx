...
export default function ActivitiesPage() {
  ...
  return (
    <div style={{ width: "100%", minHeight: "100vh", fontFamily: "'Sora', 'Inter', sans-serif", background: "linear-gradient(135deg, #061428 0%, #0b2045 35%, #0a2e3a 70%, #071830 100%)", padding: "32px" }}>
